...
const { get, getById, create, update, destroy } = require('../controllers/ProfileControllerDemo');
 ...
 * /api/perfiles:
 *   get:
 *     summary: Obtiene todos los perfiles (DEMO - Sin BD)
 *     tags: [Perfiles]
 *     parameters:
 *       - in: query
 *         name: nombre
 ...
 * /api/perfiles/{id}:
 *   get:
 *     summary: Obtiene un perfil por ID (DEMO - Sin BD)
 *     tags: [Perfiles]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 * /api/perfiles:
 *   post:
 *     summary: Crea un nuevo perfil (DEMO - Sin BD)
 *     tags: [Perfiles]
 *     requestBody:
 *       required: true
 *       content:
 ...
 * /api/perfiles/{id}:
 *   put:
 *     summary: Actualiza un perfil existente (DEMO - Sin BD)
 *     tags: [Perfiles]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 * /api/perfiles/{id}:
 *   delete:
 *     summary: Elimina un perfil (DEMO - Sin BD)
 *     tags: [Perfiles]
 *     parameters:
 *       - in: path
 *         name: id
